  ...
  return (
    <div className='mt-12 py-8 grid grid-cols-1 md:grid-cols-2'>
       ...
       <div className='flex justify-start gap-4 items-center h-screen w-full flex-col px-4  md:px-32 '>
        ...
        <h2 className='text-3xl py-8 font-semibold uppercase'>Welcome to signup</h2>
        
        <input type="text" required placeholder='Fullname'  className='p-3 text-lg px-4 border border-slate-950 rounded-full w-full'/>
        ...
        <div className='w-full bg-black text-white font-semibold text-xl py-3 my-3 shadow-md backdrop:blur-3xl shadow-black flex justify-center items-center rounded-md'> Signup</div>
